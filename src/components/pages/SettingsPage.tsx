...
export const SettingsPage = () => {
  return (
    <div className="container mx-auto p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        <Link to="/" className="inline-flex items-center gap-2 clay-button mb-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mb-4" style={{ color: 'var(--color-text-muted)' }}>
                Your data is stored locally on this device. Use import/export to backup or transfer your data.
              </p>
              <Link to="/data-management" className="clay-button clay-button-accent inline-flex items-center gap-2">
