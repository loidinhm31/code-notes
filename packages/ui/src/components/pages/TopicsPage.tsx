...
import { Button, Input } from "@code-notes/ui/components/atoms";
import { Modal } from "@code-notes/ui/components/molecules";
import { TopicForm } from "@code-notes/ui/components/organisms";
    ...
    <div className="min-h-screen-safe circuit-pattern">
      <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {searchKeyword && (
          <div className="mb-4">
            <p style={{ color: "var(--color-text-muted)" }}>
              Found {topicsSearchResults.length} topics matching "
              {searchKeyword}"
            </p>
          </div>
        )}
