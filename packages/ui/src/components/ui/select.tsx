...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "focus:outline-none focus:border-[var(--color-primary)] focus:shadow-[var(--shadow-clay-md)]",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-sm font-semibold text-[var(--color-text-primary)]",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-[var(--radius-sm)] py-2 pl-8 pr-2 text-sm",
      "text-[var(--color-text-primary)]",
      "outline-none transition-colors",
      "focus:bg-[var(--color-secondary)] focus:text-[var(--color-text-primary)]",
