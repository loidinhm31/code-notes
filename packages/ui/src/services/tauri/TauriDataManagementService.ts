...
import { type IDataManagementService, type DatabaseStats, type ExportResult, type GenericImportResult } from "../interfaces";
...
export class TauriDataManagementService implements IDataManagementService {
    ...
    async exportDatabase(path?: string): Promise<ExportResult> {
        try {
            ...
            return await invoke<ExportResult>("export_database", { exportPath: path });
        } catch (error) {
